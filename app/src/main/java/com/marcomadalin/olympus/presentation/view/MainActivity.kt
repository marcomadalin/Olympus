...
class MainActivity : AppCompatActivity() {
    ...
    override fun onStart() {
        ...
        var exercise1 = Exercise(0, 0, 0, Duration.ofSeconds(120),"Felt Fresh", 0, listOf(set1, set2, set3))

        var set4 = Set(0, 0, 15.0, 10, 9, 12.0, 14, SetType.Normal, 0)
        var set5 = Set(0, 0, 15.0, 9, 9, 12.0, 14, SetType.Normal, 1)
        var exercise2 = Exercise(0, 0, 1, Duration.ofSeconds(80),"Second set was easier", 0, listOf(set4, set5))
        ...
        var exercise3 = Exercise(0, 0, 0, Duration.ofSeconds(130),"", 0, listOf(set6, set7, set8))
        ...
        var exercise4 = Exercise(0, 0, 0, Duration.ofSeconds(150),"Felt heavy", 0, listOf(set9, set10, set11))
