...
class MainActivity : AppCompatActivity() {
    ...
    override fun onStart() {
        ...
        val exercise1 = Exercise(0, 0, 0,0, Duration.ofSeconds(120),"Felt Fresh", 0, mutableListOf(set1, set2, set3))

        val set4 = Set(0, 0, 15.0, 10, 9, 12.0, 14, SetType.Normal, 0)
        val set5 = Set(0, 0, 15.0, 9, 9, 12.0, 14, SetType.Normal, 1)
        val exercise2 = Exercise(0, 0, 0,1, Duration.ofSeconds(80),"Second set was easier", 0, mutableListOf(set4, set5))
        ...
        val exercise3 = Exercise(0, 0, 0,0, Duration.ofSeconds(130),"", 0, mutableListOf(set6, set7, set8))
        ...
        val exercise4 = Exercise(0, 0, 0,0, Duration.ofSeconds(150),"Felt heavy", 0, mutableListOf(set9, set10, set11))
        ...
        val exercise5 = Exercise(0, 0, 0,0, Duration.ofSeconds(130),"Can improve next time", 0, mutableListOf(set12, set13, set14, set15))
        ...
        val exercise11 = Exercise(0, 0, 0,0, Duration.ofSeconds(120),"Felt Fresh", 0, mutableListOf(set110, set21, set31))

        val set41 = Set(0, 0, 15.0, 10, 9, 12.0, 14, SetType.Normal, 0)
        val set51 = Set(0, 0, 15.0, 9, 9, 12.0, 14, SetType.Normal, 1)
        val exercise21 = Exercise(0, 0, 0,1, Duration.ofSeconds(80),"Second set was easier", 0, mutableListOf(set41, set51))
        ...
        val exercise31 = Exercise(0, 0, 0,0, Duration.ofSeconds(130),"", 0, mutableListOf(set61, set71, set81))
        ...
        val exercise41 = Exercise(0, 0, 0,0, Duration.ofSeconds(150),"Felt heavy", 0, mutableListOf(set91, set101, set111))
        ...
        val exercise51 = Exercise(0, 0, 0,0, Duration.ofSeconds(130),"Can improve next time", 0, mutableListOf(set121, set131, set141, set151))


        val routine = Routine(0, 1, "Legs", "Pretty chill workout",
            mutableListOf(exercise11, exercise21, exercise31, exercise41, exercise51),
            mutableListOf())
