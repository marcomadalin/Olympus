...
class ExerciseDataSelectViewHolder(view: View) : RecyclerView.ViewHolder(view) {
    ...
    fun render(
        ...
        lastFavorite: Int,
        selectExercise: (ExerciseData) -> Unit,
        ...
        if (selectedExercises.contains(exerciseData.id)) binding.exerciseLayout.setBackgroundResource(R.color.buttons)
